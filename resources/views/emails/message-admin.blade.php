...
<head>
    ...
    <title>Mensaje Administrador GML</title>
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-c" align="left"
                                                                    ...
                                                                    <h1
                                                                        ...
                                                                        Informe de Creación de Usuarios de GML</h1>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        El Siguiente es el Listado de usuarios
                                                                        registrados a las fecha en el sistema de
                                                                        administración de usuarios de GML.</p>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center"
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center" style="padding:0;Margin:0">
                                                                    <h2
                                                                        ...
                                                                        Usuarios Registrados por Pais</h2>
                                                                        <br>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                ...
                                                                style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                                    <tr style="border-collapse:collapse">
                                                                        <td align="center" style="padding:0;Margin:0"><b>Pais Usuario</b></td>
                                                                        <td align="center" style="padding:0;Margin:0"><b>Cantidad de Usuarios</b></td>
                                                                    </tr>
                                                                    
                                                                        @foreach ($users_countries as $user_con)
                                                                        <tr style="border-collapse:collapse">
                                                                            <td align="center" style="padding:0;Margin:0">{{ $user_con['country_user'] }}</td>
                                                                            <td align="center" style="padding:0;Margin:0">{{ $user_con['quantity_users'] }}</td>
                                                                        </tr>
                                                                        @endforeach
                                                                </table>
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center"
                                                                    style="padding:0;Margin:0;font-size:0"><img
                                                                        src="https://taxdcn.stripocdn.email/content/guids/CABINET_75694a6fc3c4633b3ee8e3c750851c02/images/18501522065897895.png"
                                                                        alt
