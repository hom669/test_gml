...
<head>
    ...
    <title>Mensaje Bienvenida GML</title>
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-c" align="left"
                                                                    ...
                                                                    <h1
                                                                        ...
                                                                        Bienvenido, Al Sistema de Usuarios de GML</h1>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        Bienvenido al sistema de administracion de
                                                                        Usuarios de GML,gracias por usar nuestra
                                                                        plataforma.</p>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center" style="padding:0;Margin:0">
                                                                    <h2
                                                                        ...
                                                                        Datos Registrados del Usuario</h2>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center"
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#777777;font-size:16px">
                                                                        <b>Nombre:</b> {{ $name_user }}
                                                                    </p>
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#777777;font-size:16px">
                                                                        <b>Identificación:</b>
                                                                        {{ $identification_user }}.<br>
                                                                    </p>
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#777777;font-size:16px">
                                                                        <b>Email:</b>
